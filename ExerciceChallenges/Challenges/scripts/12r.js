...
function confirmeDeleteMessage(){
  document.querySelector('.js-reset-score-container').innerHTML = `<p>
  ...
  document.querySelector('.js-yes-button').addEventListener('click', ()=>{
    resetScore();
    document.querySelector('.js-reset-score-container').innerHTML = '';
  });
...
function pickComputerMove() {
  ...
  if (0 <= randomNumber && randomNumber < 1/3){
    computerMove = 'rock';
  } else if (1/3 <= randomNumber && 2/3 > randomNumber) {
    computerMove = 'paper';
